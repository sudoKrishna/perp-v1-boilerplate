...
│   │    ├── order.ts         # place / cancel order
│   │    ├── positions.ts     # open / closed positions
│   │    └── wallet.ts        # collateral / deposit
│   ├── /controllers
│   │    ├── authController.ts
│   │    ├── orderController.ts
...
│   │    ├── orderService.ts
│   │    ├── positionService.ts
│   │    ├── tradeEngine.ts       # core matching engine
│   │    ├── liquidationEngine.ts # liquidation logic
│   │    └── marketDataService.ts # fetch Binance prices
│   ├── /queues
│   │    ├── orderQueue.ts
│   │    ├── liquidationQueue.ts
│   │    └── tradeQueue.ts
...
│        └── helpers.ts
└── /scripts
     └── seedData.ts          # dummy users / orders for testing